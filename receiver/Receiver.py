...
class EMSReceiver(stomp.ConnectionListener):
    ...
    def on_message(self, headers, message):
        ...
        except: #this section deals with the case when the message is not a json message and as a result cannot me processed. Considering that the messages are generated by the NFVO this is not supposed to happen
